...
This scraper extracts job listings for **CEMACON SA** (CIF: 677858) from the company's own careers site and from ANOFM, and imports them to peviitor.ro.

Targets: https://cemacon.ro/cariere/, , https://mediere.anofm.ro
...
- **Cemacon — listing**: `https://cemacon.ro/cariere/` — pagina publică de posturi deschise (HTML server-rendered)
- **Cemacon — sitemap**: `` — permalink-uri canonice `/joburi/<slug>/`
