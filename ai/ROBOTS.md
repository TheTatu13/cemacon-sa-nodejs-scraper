...
Fill this in per derived company. Check `https://cemacon.ro/robots.txt` before the
...
| Path | Role |
|---|---|
| `https://cemacon.ro/cariere/` | Public list of open positions (server-rendered HTML) |
| `` | Job sitemap — canonical `https://cemacon.ro/cariere/<slug>/` permalinks |
| `https://cemacon.ro/cariere/<slug>/` | Individual job pages (only referenced, not fully crawled) |
